...
var atoms = [
  ...
  {name: 'La', dist: '6s24f05d1'},
  {name: 'Ce', dist: '6s24f2'},
  {name: 'Pr', dist: '6s24f3'},
  {name: 'Nd', dist: '6s24f14'},
  {name: 'Pm', dist: '6s24f5'},
  {name: 'Sm', dist: '6s24f6'},
  {name: 'Eu', dist: '6s24f7'},
  {name: 'Gd', dist: '6s24f75d1'},
  {name: 'Tb', dist: '6s24f9'},
  {name: 'Dy', dist: '6s24f10'},
  {name: 'Ho', dist: '6s24f11'},
  {name: 'Er', dist: '6s24f12'},  
  {name: 'Tm', dist: '6s24f13'},
  {name: 'Yb', dist: '6s24f14'},
  {name: 'Ac', dist: '7s25f06d1'},
  {name: 'Th', dist: '7s25f06d2'},
  {name: 'Pa', dist: '7s25f26d1'},
  {name: 'U', dist: '7s25f36d1'},
  {name: 'Np', dist: '7s25f46d1'},
  {name: 'Pu', dist: '7s25f6'},
  {name: 'Am', dist: '7s25f7'},
  {name: 'Cm', dist: '7s25f76d1'},
  {name: 'Bk', dist: '7s25f86d1'},
  {name: 'Cf', dist: '7s25f10'},
  {name: 'Es', dist: '7s25f11'},
  {name: 'Fm', dist: '7s25f12'},
  {name: 'Md', dist: '7s25f13'},
  {name: 'No', dist: '7s25f14'},
